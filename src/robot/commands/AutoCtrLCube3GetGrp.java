 ...
 *
 */
public class AutoCtrLCube3GetGrp extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutoCtrLCube3GetGrp() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	// ******************************************************************************************
    	// 							 Pickup Third Cube on Left Switch								* 
    	// ******************************************************************************************
    	
    	addParallel(new 	IntakeAutoRetractCmd());
    	
        // 					DriveFwd2Cmd (  dist,   pwr,  hdg,  Mode, TO,  BrakeFlag, LimitOveride)
    	addSequential(new 	DriveFwd2Cmd (  36.0,   0.70, 45.0,   1,   3,    false,     false));
    	...
    	// Did'nt pull back as far to speed things up in placing cube
       	addSequential(new 	DriveFwd2Cmd ( -20.0,   0.70, 45.0,   1,   3,    false,     false));
    	addSequential(new  DriveBrakeCmd (  3.0));
        ...
        // 					DriveFwd2Cmd (  dist,   pwr,   hdg,  Mode, TO,  BrakeFlag, LimitOveride)
    	addSequential(new 	DriveFwd2Cmd (  20.0,   0.75,  0.0,   1,    3,    false,     false));
