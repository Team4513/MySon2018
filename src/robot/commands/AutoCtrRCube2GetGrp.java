 ...
 *
 */
public class AutoCtrRCube2GetGrp extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutoCtrRCube2GetGrp() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	// ******************************************************************************************
    	// 			 					Pickup Second Cube on Right Switch							* 
    	// ******************************************************************************************  
	
    	addParallel(new 	IntakeAutoRetractCmd());
    	
        // 					DriveFwd2Cmd (  dist,   pwr,  hdg,  Mode, TO,  BrakeFlag, LimitOveride)
    	addSequential(new 	DriveFwd2Cmd (  38.0,   0.65, -47.0,   1,   3,    false,     false));
        ...
        // 					DriveFwd2Cmd (  dist,   pwr,   hdg,  Mode, TO,  BrakeFlag, LimitOveride)
    	addSequential(new 	DriveFwd2Cmd (  25.0,   0.65,  0.0,   1,    3,    false,     false)); 
