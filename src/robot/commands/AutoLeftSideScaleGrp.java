 ...
 *
 */
public class AutoLeftSideScaleGrp extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutoLeftSideScaleGrp() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	addSequential(new DriveArcTurnCmd(   0.25,    0.85,    0,  -30,   1,   5,    false,     false));    	
    	addSequential(new DriveArcTurnCmd(   0.85,    0.25,    0,   -5,    1,   5,    false,     false));  
    	//addSequential(new 	DriveBrakeCmd		(  3.0));    	*test*
    	...
    	addParallel(new 	AutoLeftSideScaleDelayLiftGrp());
    	...
    	addSequential(new 	AutoLeftSideScaleLiftGrp());
    	
    	// 			      				 		(tgtist,   Pwr,   Hdg,  Mode, TO,  Brake, LimitOveride)
    	addSequential(new 	DriveFwd2Cmd		( 10.0,   0.70,   84.0,   1,  3.0,  false,  false));
    	...
    	addSequential(new 	AutoLeftSideScaleDropGrp() ); 
    } 
}
