 ...
 *
 */
public class AutoRightSideScaleGrp extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutoRightSideScaleGrp() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	// ******************************************************************************************
    	// 				 					Drive to Right Side Scale						 		* 
    	// ******************************************************************************************   
    	
       	//					armToPosCmd(position,  speed, mode,   timeOut
    	addParallel(new 	armToPosCmd("Scale",   0.0,   3.0,    3.0));
    	
       	//				  DriveArcTurnCmd( leftPwr, rightPwr, dist, hdg, mode, TO, BrakeFlag,  PIDMode)
    	addSequential(new DriveArcTurnCmd(   0.85,    0.25,    0,    32,   1,   5,    false,     false));    	
    	addSequential(new DriveArcTurnCmd(   0.25,    0.85,    0,    5.0 ,    1,   5,    false,     false));    	
    	...
    	addParallel(new 	AutoRightSideScaleDelayLiftGrp());
    	
    	// 			      				 		(tgtDist,    Mode,   TO,   Hdg)
    	addSequential(new 	DriveFwdPidCmd		(  256.5,      1,    6.0,   0.0));
    	...
    	addSequential(new 	AutoRightSideScaleLiftGrp());
    	
    	// 			      				 		(tgtist,   Pwr,   Hdg,  Mode, TO,  Brake, LimitOveride)
    	addSequential(new 	DriveFwd2Cmd		( 10.0,   0.70,  -85.0,   1,  3.0,  false,  false));
    	...
    	addSequential(new 	AutoRightSideScaleDropGrp() ); 
